#Ordenar lista en pares e impares y que se ordenen ascendentemente

def OrdenarParImpar(lista1,lista2):
    if isinstance(lista1,list) and isinstance(lista2,list):
        return OrdenarAux(lista1,lista2,[],[],[])
    else:
        print("Error en parámmetros de entrada")
def OrdenarAux(lista1,lista2,pares,impares,res):
    if lista1==[] and lista2==[]:
        return res+[ordenarLista(pares)]+[ordenarLista(impares)]
    else:
        if lista1[0]%2==0 and lista2[0]%2==0:
            return OrdenarAux(lista1[1:],lista2[1:],pares+[lista1[0]]+[lista2[0]],impares,res)
        if lista1[0]%2!=0 and lista2[0]%2!=0:
            return OrdenarAux(lista1[1:],lista2[1:],pares,impares+[lista1[0]]+[lista2[0]],res)
        if lista1[0]%2!=0 and lista2[0]%2==0:
            return OrdenarAux(lista1[1:],lista2[1:],pares+[lista2[0]],impares+[lista1[0]],res)
        else:
            return OrdenarAux(lista1[1:],lista2[1:],pares+[lista1[0]],impares+[lista2[0]],res)
